    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center " href="panel">
                ...
                <img src="{{ asset('images/hello-world-admin-logo.png') }}" style="width: 30px;" alt="hello world admin logo">
                <div class="sidebar-brand-text mx-2">Hello World</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link  ff-Formula-1" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-server" style="color: #62bff3;"></i>
                    <span>Servidor</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="registros">Logs</a>
                        <a class="collapse-item" href="recursos-servidor">Uso del Servidor</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Administrador -->
            <li class="nav-item ">
                <a class="nav-link" href="https://test.hello-world.space/inicio">
                    <img src="{{ asset('images/hello-world-logo.png') }}" style="width: 15px;" alt="hello world admin logo">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('images/svg/undraw_profile_1.svg') }}"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('images/svg/undraw_profile_2.svg') }}"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('images/svg/undraw_profile_3.svg') }}"
                                            alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hot Taco Loco</span>
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('images/profile/hot_taco.jpg') }}">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Hello-World 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <script src="{{ asset('js/demo/chart-server-usage.js') }}"></script>
